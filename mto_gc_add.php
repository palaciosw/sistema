...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0">
	<tr height="31px">
    	<td width="25"><img src="img/layer_add.png"></td>
        <td style="font-size:14px; text-shadow: 0 0 150px #FFF, 0 0 60px #FFF, 0 0 10px #CCC">Registrar Grupos de Concepto</td>
    </tr>
</table>
<br>
...
if(isset($_POST['btnGuarda']))
{
	...
	{
		$sql  = "INSERT INTO grupo (descripcion) VALUES ('$dDes')";
