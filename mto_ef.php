...
$sql = "SELECT entidad.id, entidad.descripcion FROM entidad ORDER BY entidad.descripcion ASC";
...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0">
	<tr>
    	<td width="25"><img src="img/building.png"></td>
        <td style="font-size:14px; text-shadow: 0 0 150px #FFF, 0 0 60px #FFF, 0 0 10px #CCC">Listado de Entidades Financieras</td>
